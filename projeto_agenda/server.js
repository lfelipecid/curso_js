...
const { checkCsrfError, csrfMiddleWare, global } = require('./src/middlewares/middlewares')
...
app.use(express.static(path.resolve(__dirname, 'public'))) // Retorna Arquvios staticos 
